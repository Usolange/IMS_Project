...
const ScheduleManager = ({ category, sadId, ikiminaList, onClose }) => {
  ...
  switch (f_category) {
    case 'Daily':
      return <DailyScheduleForm f_id={f_id} ikiminaList={ikiminaList} onClose={onClose} />;
    case 'Weekly':
      return <WeeklyScheduleForm f_id={f_id} ikiminaList={ikiminaList} onClose={onClose} />;
    case 'Monthly':
      return <MonthlyScheduleForm f_id={f_id} ikiminaList={ikiminaList} onClose={onClose} />;
    default:
      return (
        <div>
